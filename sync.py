    ...
    if sheetname == "Monitoring Piping" :
        ...
        for i, row in df.iterrows():
            ...
            if typedf == "matl":
                ...
                ws.cell(row=startrow + i, column=pg, value = f"=IFERROR(IF(INDEX('DB MATL'!${dbh}:${dbh}, MATCH(${vpcode}{startrow + i}, 'DB MATL'!${dba}:${dba}, 0)) = 0, \"\", INDEX('DB MATL'!${dbh}:${dbd}, MATCH(${vpcode}{startrow + i}, 'DB MATL'!${dba}:${dba}, 0))), \"\")")
                ...
                ws.cell(row=startrow + i, column=sg, value = f"=IFERROR(IF(INDEX('DB MATL'!${dbh}:${dbh}, MATCH(${vscode}{startrow + i}, 'DB MATL'!${dba}:${dba}, 0)) = 0, \"\", INDEX('DB MATL'!${dbh}:${dbd}, MATCH(${vscode}{startrow + i}, 'DB MATL'!${dba}:${dba}, 0))), \"\")")
                ...
                ws.cell(row=startrow + i, column=tg, value = f"=IFERROR(IF(INDEX('DB MATL'!${dbh}:${dbh}, MATCH(${vtcode}{startrow + i}, 'DB MATL'!${dba}:${dba}, 0)) = 0, \"\", INDEX('DB MATL'!${dbh}:${dbd}, MATCH(${vtcode}{startrow + i}, 'DB MATL'!${dba}:${dba}, 0))), \"\")")
