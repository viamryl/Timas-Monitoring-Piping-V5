...
def check_password():
    ...
    st.header("PIPING PROGRESS", anchor=False)
    ...
    col2.text_input("Password", type="password", on_change=password_entered, key="password")
    if not st.session_state.password_correct:
        col2.warning("😕 Password incorrect or session expired, Enter password again")
